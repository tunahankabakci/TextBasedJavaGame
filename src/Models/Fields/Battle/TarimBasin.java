...
public class TarimBasin extends BattleField{

    public TarimBasin() {
        super(2,"Tarim Basin",new Fire());
    }

    public TarimBasin(Character character) {
        super(2, "Tarim Basin", character, BattleFieldType.TARIM_BASIN, generateMonster(MonsterType.SCORPION, 3), new Fire());
    }
